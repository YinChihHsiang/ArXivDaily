...
# Keywords to search
KEYWORD_LIST = ["Blanford", "Znajek", "Kerr-Bertotti-Robinson black hole", "Kerr-Bertotti-Robinson", "KBR"]#["exact solution", "modified gravity", "nonlinear electrodynamics", "black hole", "Blanford", "Znajek"]
# Keywords to exclude
KEYWORD_EX_LIST = []
